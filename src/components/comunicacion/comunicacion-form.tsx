  ...
  export default function ComunicacionForm({
    ...
    const handleSubmit = async () => {
      try {
        ...
        toast.success(`Comunicación ${isCreating ? "creada" : "actualizada"} exitosamente`);
        onComunicacionSaved?.();
        onClose();
      } catch (err) {
      ...
      <Dialog open={open} onOpenChange={onClose}>
        <DialogContent className="max-w-3xl">
          ...
          <div className="grid grid-cols-1 gap-4 pt-4">
            ...
            <div className="flex flex-col">
              ...
              <textarea
                ...
                onChange={handleChange}
                className={clsx("border rounded-md p-2", errors.mensaje && "border-red-500")}
              />
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-wrap gap-2">
                {opcionesDirigidoA.map((opcion) => (
                  <Button
                    key={opcion}
                    variant={formData.dirigido_a.includes(opcion) ? "default" : "outline"}
          ...
          <Button className="w-full mt-6 cursor-pointer" onClick={handleSubmit}>
            {isCreating ? "Crear comunicación" : "Actualizar comunicación"}
          </Button>
        </DialogContent>
      </Dialog>
    );
